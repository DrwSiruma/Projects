                    ...
                    <h4 class="m-1 text-lg text-dark">Product category</h4>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs">
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#shoes" data-toggle="tab">SHOES</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#crocs" data-toggle="tab">CROCS</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#slippers" data-toggle="tab">SLIPPERS</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#socks" data-toggle="tab">SOCKS</a>
                              </li>
