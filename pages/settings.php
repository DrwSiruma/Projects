...
$opt .= "</select>";
      ...
      ?>
        ...
        <div class="card shadow mb-4 col-xs-12 col-md-12 border-bottom-dark">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-dark">Edit Account Info</h4>
            </div>
            <div class="card-body">
              ...
              <div class="form-group row text-left text-primary">
                ...
                <div class="col-sm-9">
                  <select class='form-control' name='gender' required>
                    <option value="" disabled selected hidden><?php echo $c; ?></option>
