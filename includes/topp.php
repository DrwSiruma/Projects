          ...
          if($_SESSION['TYPE'] == 'Admin'){ ?>
            <a class="sidebar-brand d-flex align-items-center justify-content-center"  style="text-decoration: none; font-size: 18px; font-weight: bold;" href="index.php">
              <div class="sidebar-brand-icon">
                ...
                <!-- <img src="../img/logo/ct_logo.jpeg" style="width:30px;height:30px;border-radius:50%;"> -->
              </div>
              <div class="sidebar-brand-text mx-3">Dashboard</div>
            </a>
            <?php
          } elseif ($_SESSION['TYPE'] == 'User'){ ?>
            <a class="sidebar-brand d-flex align-items-center justify-content-center"  style="text-decoration: none; font-size: 18px; font-weight: bold;" href="pos.php">
              <div class="sidebar-brand-icon">
                <i class="fas fa-laugh-wink"></i>
                <!-- <img src="../img/logo/ct_logo.jpeg" style="width:30px;height:30px;border-radius:50%;"> -->
              </div>
              <div class="sidebar-brand-text mx-3">Local Streetware</div>
            </a>
            <?php
          } ?>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <?php if ($_SESSION['TYPE'] == 'User'){ ?>
              <a class="nav-link" href="#" role="button">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Cart <i class="fas fa-shopping-cart"></i></span>
              </a>
            <?php } else { ?>
              ...
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <?php
                  // if($_SESSION['GENDER']=='Male'){
                    echo 'src="../img/avatar/avtr_male.png"';
                  // }else{
                    // echo 'src="../img/avatar/avtr_female.png"';
                  // }
                ?>>
